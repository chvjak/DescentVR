...
void android_main(struct android_app* app) {
    ...
    while (app->destroyRequested == 0) {
        ...
        ovrRenderThread_Submit(
            ...
            &tracking);
#else
        // HERE WILL BE GAME LOOP
        // appState will be passed to RenderFrame(appState)
        // RenderFrame()  will call all necessary vrapi_ functions: GetTracking, setFrameBuffer, etc
